const Footer = () => {
  ...
  const socialLinks = [
    {
      name: 'Instagram',
      url: 'https://instagram.com/lacreme',
      icon: (
    ...
    {
      name: 'Facebook',
      url: 'https://facebook.com/lacreme',
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
            ...
            <div className="flex space-x-4">
              {socialLinks.map((social) => (
                <a
                  ...
                  className="w-10 h-10 rounded-full border border-accent-gray-light flex items-center justify-center text-accent-white hover:border-primary-gold hover:text-primary-gold hover:scale-110 transition-all duration-300"
                >
                  {social.icon}
                </a>
              ))}
